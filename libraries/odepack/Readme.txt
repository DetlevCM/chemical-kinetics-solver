...
developed by Alan C. Hindmarsh at LLNL, only compile instructions will be supplied 
for now.
...
I cannot recommend the best compilation method, however these a number of options I have 
tried - with seemingly identical results regarding runtime...

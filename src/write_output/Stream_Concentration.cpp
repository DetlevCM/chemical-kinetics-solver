...
void WriteOutput::Write_Header_Species_Temperature_Pressure(
    string filename, string separator, size_t Number_Species,
    vector<Species> species, bool GasPhasePressure) {
  size_t i;
...
void WriteOutput::StreamConcentrations(ofstream &Concentration_OFStream,

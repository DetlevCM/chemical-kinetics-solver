...
public:
  ...
  static void ReportAccuracy(string, size_t, vector<Species> species, string,
                             string, string);

  static vector<bool> Read_Kill_List(string filename, vector<Species> species);

  static void ReactionRateImportance(vector<double> &KeyRates,
  ...
  static vector<vector<string>> Get_Combine_Species_Mapping(string filename);

  static vector<ClassNaming> GetSpeciesClassesNames(vector<vector<string>>);

  static vector<Species>
  RenameSpecies(vector<Species> species, vector<ClassNaming> UserDefinedNames,
                const vector<size_t> &SpeciesClassMapping);

  static vector<size_t> Map_Species_Classes(const vector<vector<string>> &,
